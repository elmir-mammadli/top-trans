<template>
  <header>
    <div>
  <nav class="max-w-screen-xl mx-auto bg-gray-600 bg-transparent transition-all .3s ease-in"
  >
  <div class="flex flex-wrap items-center justify-between mx-auto mt-8">
